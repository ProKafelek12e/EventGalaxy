<ul id="tabs">
    <li class="tab active"><a href="./index.php"><img src="./icons/home.svg"><h3>Home</h3></a></li>
    <li class="tab active"><a href="./calendar.php"><img src="./icons/calendar.svg"><h3>Calendar</h3></a></li>
    <li class="tab active"><a href="./login.php"><img src="./icons/logIn.svg"><h3>Log in</h3></a></li>
    <?php
